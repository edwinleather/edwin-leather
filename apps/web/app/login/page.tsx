  ...
  return (
    <div className="auth-page">
      <div className="auth-visual">
        <Image src="https://res.cloudinary.com/gpldwiup/image/upload/edwin/assets/mgzyaetkznw6ft1f6tdi.webp" alt="Brown leather bag detail" fill priority sizes="(max-width: 900px) 100vw, 48vw" />
