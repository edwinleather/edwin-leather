...
// Backoffice media upload also sends base64 data URIs.
app.use("/api/v1/admin/media/upload", express.json({ limit: "14mb" }));
app.use("/api/v1/admin/media/replace", express.json({ limit: "14mb" }));
